...
if( isset($_GET['install']) ){
  ...
  sqlconector("CREATE TABLE IF NOT EXISTS TRADER (
    ...
    PORCENVENTA DECIMAL(16,4) NOT NULL DEFAULT 0.00,
    MARGEN DECIMAL(16,4) NOT NULL DEFAULT 0.00,
  ...
  sqlconector("CREATE TABLE IF NOT EXISTS DATOS (
    ...
    BALANCE_ASSET DECIMAL(16,4) NOT NULL DEFAULT 0.00,
    PRECIO_VENTA DECIMAL(16,2) NOT NULL DEFAULT 0.00,
    PANTE DECIMAL(16,4) NOT NULL DEFAULT 0.00,
...
sqlconector("CREATE TABLE IF NOT EXISTS PRICES (
  ...
  FECHA TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  MONEDA VARCHAR(10) DEFAULT 'BTCUSDT',
  ACTUAL DECIMAL(16,4) NOT NULL DEFAULT 0.00,
  ARRIBA DECIMAL(16,4) NOT NULL DEFAULT 0.00,
  ABAJO DECIMAL(16,4) NOT NULL DEFAULT 0.00,
